...
run_case() {
  ...
  (
    ...
    # Execution policy is selected only by the per-pipeline private pNext.
    # Standard workloads omit it and therefore use MegaKernel.
    unset VENTUS_VK_INTERNAL_RT_ORACLE_PROFILE
